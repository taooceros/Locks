...
```
src/
├── main.rs                 # Entry point: CLI parsing, env info, dispatch
├── command_parser.rs       # Clap structs (App, GlobalOpts)
├── command_parser/
│   ├── experiment.rs       # DLock1Experiment / DLock2Experiment enums
│   └── lock_target.rs      # DLock1Target / DLock2Target enums + constructors
