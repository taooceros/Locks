...
type FCPQBTree =
    FCPQ<u64, u64, BTreeSet<UsageNode<'static, u64>>, Delegate, RawSpinLock>;
...
dlock2_counter_tests!(fc_ban, FCBan::<u64, u64, Delegate>::new(0_u64, counter_delegate));

dlock2_counter_tests!(cc, CCSynch::<u64, u64, Delegate>::new(0_u64, counter_delegate));

dlock2_counter_tests!(cc_ban, CCBan::<u64, u64, Delegate>::new(0_u64, counter_delegate));

dlock2_counter_tests!(dsm, DSMSynch::<u64, u64, Delegate>::new(0_u64, counter_delegate));

dlock2_counter_tests_serial!(fc_sl, FCSL::<u64, u64, Delegate>::new(0_u64, counter_delegate));
